    ...
    >
      ...
      >
        <h1 className="text-white font-medium text-2xl mb-4">
          Sign In to <span className="text-teal-500">Virtual Assistant</span>
        </h1>
        ...
        <p className="text-white">
           Want to create an account? Click to <span onClick={()=>navigate('/signup')} className="text-teal-500 hover:underline cursor-pointer">Sign Up</span>
        </p>
      </form>
    </div>
  );
